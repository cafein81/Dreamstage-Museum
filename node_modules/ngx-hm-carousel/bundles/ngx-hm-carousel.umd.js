(function (global, factory) {
    ...
    var NgxHmCarouselComponent = /** @class */ (function () {
        ...
        function () {
             ...
             * @return {?}
             */
            function () { return _this.containerResize(); }))).pipe(operators.takeUntil(this.destroy$)).subscribe();
        };
        /**
         * @return {?}
         */
        ...
        function () {
            ...
            if (this.btnNext && this.btnPrev) {
                return rxjs.forkJoin(rxjs.fromEvent(this.btnNext.nativeElement, 'click').pipe(operators.tap((/**
                 * @return {?}
                 */
                function () { return _this.currentIndex++; }))), rxjs.fromEvent(this.btnPrev.nativeElement, 'click').pipe(operators.tap((/**
                 * @return {?}
                 */
        ...
        function (index) {
            ...
            if (this.runLoop) {
                ...
                if (state_1 !== 0) {
                    ...
                    this.saveTimeOut = rxjs.timer(this.aniTime).pipe(operators.switchMap((/**
                     * @return {?}
                     */
                    function () {
                        ...
                        if (_this.aniTime === _this.speed) {
                            ...
                            return rxjs.timer(50).pipe(operators.tap((/**
                             * @return {?}
                             */
                            function () {
        ...
        NgxHmCarouselComponent.propDecorators = {
            ...
            infiniteContainer: [{ type: core.ContentChild, args: ['infiniteContainer', { static: false, read: core.ViewContainerRef },] }],
            contentContent: [{ type: core.ContentChild, args: ['carouselContent', { static: false },] }],
