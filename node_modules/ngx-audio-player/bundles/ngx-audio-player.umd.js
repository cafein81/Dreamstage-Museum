(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('rxjs'), require('@angular/material'), require('@angular/common'), require('@angular/core'), require('@fortawesome/angular-fontawesome'), require('@fortawesome/fontawesome-svg-core'), require('@fortawesome/free-solid-svg-icons'), require('@angular/forms'), require('@angular/platform-browser/animations')) :
    typeof define === 'function' && define.amd ? define('ngx-audio-player', ['exports', 'rxjs', '@angular/material', '@angular/common', '@angular/core', '@fortawesome/angular-fontawesome', '@fortawesome/fontawesome-svg-core', '@fortawesome/free-solid-svg-icons', '@angular/forms', '@angular/platform-browser/animations'], factory) :
    (factory((global['ngx-audio-player'] = {}),global.rxjs,global.ng.material,global.ng.common,global.ng.core,global['@fortawesome/angular-fontawesome'],global['@fortawesome/fontawesome-svg-core'],global['@fortawesome/free-solid-svg-icons'],global.ng.forms,global.ng.platformBrowser.animations));
}(this, (function (exports,rxjs,material,common,core,angularFontawesome,fontawesomeSvgCore,freeSolidSvgIcons,forms,animations) { 'use strict';
    ...
    var NgxAudioPlayerModule = /** @class */ (function () {
        ...
        NgxAudioPlayerModule.decorators = [
            { type: core.NgModule, args: [{
                        ...
                        imports: [common.CommonModule, animations.BrowserAnimationsModule, forms.FormsModule, angularFontawesome.FontAwesomeModule, MaterialModule],
